...
{
    public class GenericGetAllRequestHandler
        <TRepository, TEntityDto, TDomainEntity>
        : IRequestHandler<GenericGetAllRequest<TEntityDto>, List<TEntityDto>>
        ...
        where TDomainEntity : class
    {
        ...
        public GenericGetAllRequestHandler(TRepository repository, IMapper mapper)
        {
            this.repository = repository;
            this.mapper = mapper;
        }
        public async Task<List<TEntityDto>> Handle(GenericGetAllRequest<TEntityDto> request, CancellationToken cancellationToken)
        {
